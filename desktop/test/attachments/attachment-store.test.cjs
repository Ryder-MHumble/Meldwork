...
const { AttachmentStore } = require('../../src/attachments/attachment-store.cjs')

test('keeps the attachment store facade limited to AttachmentStore', () => {
  assert.deepEqual(Object.keys(require('../../src/attachments/attachment-store.cjs')), ['AttachmentStore'])
})
