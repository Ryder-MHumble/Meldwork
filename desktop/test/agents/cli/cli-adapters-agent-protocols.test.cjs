...
const { AGENT_RUNTIME_CAPABILITIES } = require('../../../src/agents/agent-runtime-contract.cjs')
const { createStructuredOutputAccumulator } = require('../../../src/agents/cli/cli-output-parsers.cjs')
const {
  ALLOWED_KINDS,
  detectAgents,
