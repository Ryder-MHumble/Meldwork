...
} = require('../../src/knowledge/knowledge-connector-contract.cjs')
const {
  FilesystemKnowledgeConnector,
} = require('../../src/knowledge/knowledge-connector-filesystem.cjs')
const { MemoryKnowledgeConnector } = require('../../src/knowledge/knowledge-connector-memory.cjs')
const { KnowledgeConnectorRegistry } = require('../../src/knowledge/knowledge-connector-registry.cjs')
