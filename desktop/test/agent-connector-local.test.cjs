...
const { createAgentConnectorManifest, serializeAgentConnectorManifest } = require('../src/agent-connector-manifest.cjs')
const { AgentConnectorInstanceStore } = require('../src/agent-connector-instance-store.cjs')
const { isSupportedAgentKind } = require('../src/local-workspace-contracts.cjs')
const {
