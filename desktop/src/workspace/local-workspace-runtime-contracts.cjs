const { DEFAULT_MAX_OUTPUT_CHARS, normalizeTraceCapsule } = require('../runs/run-harness.cjs')
const {
...
const DEFAULT_RUN_AGENT_TIMEOUT_MS = 3 * 60 * 1000
const DEFAULT_RUN_AGENT_TOOL_TIMEOUT_MS = 5 * 60 * 1000
