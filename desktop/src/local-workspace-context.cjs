...
function promptFor({
  ...
  const mediaDelivery = group.allowWrite
      ? [
          ...
          'Supported media attachments include .png, .jpg, .jpeg, .mp3, .wav, .m4a, .mp4, .mov, and .webm; other recognized outputs remain durable Artifacts without being treated as chat attachments.',
        ].join('\n')
    : [
