...
<p align="center">
  <a href="https://github.com/Ryder-MHumble/Meldwork/releases/download/Meldwork-V1.0.2/Meldwork-0.1.2-arm64.dmg"><strong>Download after the V1.0.2 prerelease is published</strong></a>
...
1. After publication, open the [Meldwork V1.0.2 prerelease target](https://github.com/Ryder-MHumble/Meldwork/releases/tag/Meldwork-V1.0.2).
